        ...
        <div className="navigate-container">
            <div className="navigate-wrap">
                <div className="navigate-chunk">
                    <h2>Your Profile</h2>
                    <NavigateItem icon={props.pic ? props.pic : ""
                    } text={props.name ? props.name : "Profile Name"} type={"profile"} onClick={props.method} radius={"25px"} />
                ...
                <div className="navigate-chunk">
                    ...
                    <NavigateItem icon="/assets/iconography2-02.png" text={props.userType === "artist" ? "Venue Directory" : "Artist Directory"} type={"profile"} onClick={() => scrollToComponent(this.Venue, { offset: 0, align: 'top', duration: 1500 })} />
                </div>
